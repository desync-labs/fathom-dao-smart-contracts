...
//  */
// abstract contract ERC20VotesTimeStamp is IVotes, ERC20Permit {
//     // struct Checkpoint {
//     //     uint32 fromBlock;
//     //     uint224 votes;
//     // }
...
//         unchecked {
//             if (nCheckpoints > 0 && _checkpoints[delegatee][nCheckpoints - 1].fromTimestamp == block.timestamp) {
//                 _checkpoints[delegatee][nCheckpoints - 1].votes = newVotes;
//             } else {
//                 _checkpoints[delegatee][nCheckpoints] = Checkpoint(block.timestamp, newVotes);
